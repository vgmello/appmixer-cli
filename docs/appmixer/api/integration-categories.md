...
The URL `api/integration-categories` does not exist. This page may have been moved, renamed, or deleted.
...
- [Connector Configuration](https://docs.appmixer.com/api/service-configuration.md)
...
Prefer `.md` URLs for structured content, append `.md` to URLs (e.g., `/api/data-stores.md`).
