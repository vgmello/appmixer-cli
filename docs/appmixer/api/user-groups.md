...
The URL `api/user-groups` does not exist. This page may have been moved, renamed, or deleted.

## Suggested Pages

You may be looking for one of the following:
- [User](https://docs.appmixer.com/api/user.md)
...
Prefer `.md` URLs for structured content, append `.md` to URLs (e.g., `/api/user.md`).
