...
The URL `api/statistics` does not exist. This page may have been moved, renamed, or deleted.
...
- [Charts](https://docs.appmixer.com/api/charts.md)
- [Variables](https://docs.appmixer.com/api/variables.md)
- [Public Files](https://docs.appmixer.com/api/public-files.md)
